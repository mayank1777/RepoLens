...
async def main():
    ...
    print('Welcome to RepoLens_Test, please enter your github username')
    user = str(input())
    ...
    #--------------------------------------------------
    model_matrix = models.load_d2v('readme', length)
    vectors = []
    ...
    similarity = 1 * sim1 + 1.2 * sim2 + 0.8 * sim3 + 0.3 * sim4
